...
export class AppRemoteConnect {
    ...
    private renderContent() {
        if (this.rooms && this.rooms.length > 0) {
            ...
            return (
                <h1>No presentations found, try to refresh yours...</h1>
            );
        }
    }
    ...
    private renderRooms() {
        return (
            this.rooms.map((activeRoom: ActiveRoom) => {
                return <ion-item onClick={() => this.updateAndCloseModal(activeRoom.room)} disabled={activeRoom.clients > 1}>
