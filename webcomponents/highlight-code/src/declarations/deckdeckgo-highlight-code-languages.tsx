...
export const deckdeckgoHighlightCodeLanguages = {
  ...
  javascript: {title: 'JavaScript', require: 'clike', modify: 'markup', alias: 'js', option: 'default'},
  ...
  regex: {title: 'Regex', modify: ['actionscript', 'coffeescript', 'flow', 'javascript', 'typescript', 'vala'], owner: 'RunDevelopment'},
  ...
  'shell-session': {title: 'Shell session', require: 'bash', owner: 'RunDevelopment'},
