...
| **Starter kit** | | ![version](https://img.shields.io/static/v1.svg?label=version&message=v1.0.0-rc.2-3&color=success) | [`Repo`](http://github.com/deckgo/deckdeckgo-starter/)
