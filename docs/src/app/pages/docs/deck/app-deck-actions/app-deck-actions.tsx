...
<ul>
<li><a href="#app-deck-actions-introduction">Introduction</a></li>
<li><a href="#app-deck-actions-theming">Theming</a></li>
<li><a href="#app-deck-actions-example">Example</a></li>
</ul>
<h2 id="app-deck-actions-introduction">Introduction</h2>
<p>The slot <code>actions</code> provided for the deck will be cloned into each slides of your presentation. Therefore this slot will follow the swiping.</p>
...
<p>The following theming options will affect the slot <code>actions</code> if set on the <code>deckgo-deck</code> or any slides.</p>
<table>
<thead>
<tr>
<th>CSS4 variable</th>
