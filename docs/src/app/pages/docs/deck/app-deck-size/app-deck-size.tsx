...
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><h2 id="app-deck-size-tips-and-tricks">Tips and tricks</h2>
<p>To detect the size of the container, the <code>offsetParent</code> property is used which returns the nearest ancestor that has a position other than static. Therefore, if the size would not be detected, try to set the <code>position</code> of your container to <code>relative</code> or <code>fixed</code>.  </p>
</main>
