  ...
  render() {
    return [
      ...
      <ion-content class="ion-padding">
        <main><h1 id="app-deck-auto-slide-auto-slide">Auto Slide</h1>
          <p>The animation between the <a href="https://deckdeckgo.com">DeckDeckGo</a> slides could happen in different ways.</p>
          <p>Per default, the animation is the <code>slide</code> effect respectively a swipe effect.</p>
          ...
          <h2 id="app-deck-auto-slide-styling">Styling</h2>
          <p>It is also possible to style the <code>fade</code> animation using the following CSS4 variables:</p>
          <table>
            <thead>
              <tr>
                <th>CSS4 variable</th>
