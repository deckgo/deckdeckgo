    ...
    return [
      ...
      <ion-content class="ion-padding">
        <main>
          ...
          <ul>
            <li>
              <a href="#app-deck-background-introduction">Introduction</a>
            </li>
            <li>
              <a href="#app-deck-background-attributes">Attributes</a>
            </li>
            <li>
              <a href="#app-deck-background-theming">Theming</a>
            </li>
            <li>
              <a href="#app-deck-background-examples">Examples</a>
            </li>
          </ul>
          ...
          <p>
            The following attribute could be applied to the <code>deckgo-deck</code> element:
          </p>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <td>
                  <code>cloneBackground</code>
                </td>
                <td>
                  <code>clone-background</code>
                </td>
                <td></td>
          ...
          <p>
            The following theming options will affect the slot <code>background</code> if set on the <code>deckgo-deck</code> or any slides.
          </p>
          <table>
            <thead>
              <tr>
          ...
          <deckgo-highlight-code language="javascript">
            <code slot="code">
              ...
              slot=&quot;content&quot;&gt;{'\n'} Hello World 🚀{'\n'} &lt;&#47;p&gt;{'\n'} &lt;&#47;deckgo-slide-title&gt;{'\n'}
              {'\n'} &lt;img slot=&quot;background&quot;
              data-src=&quot;https:&#47;&#47;deckdeckgo.com&#47;assets&#47;favicon&#47;android-chrome-512x512.png&quot;&gt;{'\n'}&lt;&#47;deckgo-deck&gt;
            </code>
          </deckgo-highlight-code>
          <p>An example with a more complex html and css element which is set as background for the all presentation:</p>
          <deckgo-highlight-code language="javascript">
            <code slot="code">
          ...
          <p>
            where for example the related <code>circle</code> css code could be:
          </p>
          <deckgo-highlight-code language="javascript">
            <code slot="code">
