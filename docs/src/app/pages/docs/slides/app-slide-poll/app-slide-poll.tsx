  ...
  render() {
    return [
      ...
      <ion-content class="ion-padding">
        <main><h1 id="app-slide-poll-slide-poll">Slide: Poll</h1>
...
<ul>
<li><a href="#app-slide-poll-layout">Layout</a></li>
<li><a href="#app-slide-poll-nota-bene">Nota bene</a></li>
<li><a href="#app-slide-poll-installation">Installation</a><ul>
<li><a href="#app-slide-poll-from-a-cdn">From a CDN</a></li>
<li><a href="#app-slide-poll-from-npm">From NPM</a></li>
<li><a href="#app-slide-poll-framework-integration">Framework integration</a></li>
</ul>
</li>
<li><a href="#app-slide-poll-usage">Usage</a><ul>
<li><a href="#app-slide-poll-slots">Slots</a></li>
<li><a href="#app-slide-poll-notes">Notes</a></li>
<li><a href="#app-slide-poll-youtube-component">Youtube component</a></li>
</ul>
</li>
<li><a href="#app-slide-poll-attributes">Attributes</a></li>
<li><a href="#app-slide-poll-theming">Theming</a></li>
<li><a href="#app-slide-poll-methods">Methods</a><ul>
<li><a href="#app-slide-poll-play-the-video">Play the video</a></li>
<li><a href="#app-slide-poll-pause-the-video">Pause the video</a></li>
<li><a href="#app-slide-poll-toggle-the-video">Toggle the video</a></li>
<li><a href="#app-slide-poll-get-the-video">Get the video</a></li>
</ul>
</li>
</ul>
...
<p>This template does <strong>not</strong> currently save the results of the voting. Each time you will refresh or launch your presentation, the poll start again.</p>
<p>If you would have this requirement, let us now with a new <a href="https://github.com/deckgo/deckdeckgo/issues">feature request</a> in our GitHub issue tracker.</p>
...
<deckgo-highlight-code language="javascript">
      <code slot="code">&lt;script type=&quot;module&quot; src=&quot;https:&#47;&#47;unpkg.com&#47;@deckdeckgo&#47;slide-poll@latest&#47;dist&#47;deckdeckgo-slide-poll&#47;deckdeckgo-slide-poll.esm.js&quot;&gt;&lt;&#47;script&gt;{'\n'}&lt;script nomodule=&quot;&quot; src=&quot;https:&#47;&#47;unpkg.com&#47;@deckdeckgo&#47;slide-poll@latest&#47;dist&#47;deckdeckgo-slide-poll&#47;deckdeckgo-slide-poll.js&quot;&gt;&lt;&#47;script&gt;</code>
    </deckgo-highlight-code><h3 id="app-slide-poll-from-npm">From NPM</h3>
...
<deckgo-highlight-code language="bash">
    ...
    </deckgo-highlight-code><h3 id="app-slide-poll-framework-integration">Framework integration</h3>
...
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><h4 id="app-slide-poll-loader">Loader</h4>
<deckgo-highlight-code language="javascript">
      <code slot="code">import &#123; defineCustomElements as deckDeckGoSlideElement &#125; from &#039;@deckdeckgo&#47;slide-poll&#47;dist&#47;loader&#039;;{'\n'}deckDeckGoSlideElement(window);</code>
...
<p>Note also that if you provide a string <code>{0}</code> in the content of your slot <code>how-to</code>, the information will be automatically converted to the real key of your poll (the key your audience could use to reach it and vote).</p>
...
<p>Moreover, this component is using the Web Components &quot;QR Code&quot; and &quot;Bar chart&quot;. Their respective CSS4 variables could be applied too.</p>
...
<deckgo-highlight-code language="javascript">
      <code slot="code">const slide = deck.getElementsByTagName(&#039;deckgo-slide-poll&#039;);{'\n'}await slide.isAnswered(); &#47;&#47; resolve a boolean</code>
