...
<ul>
<li><a href="#app-remote-control-how-does-it-work">How does it work</a></li>
<li><a href="#app-remote-control-give-a-try">Give it a try</a></li>
...
<p>The same Progressive Web App <a href="https://deckdeckgo.app">remote control</a> could be used to control any presentations developed with <a href="https://deckdeckgo.com">DeckDeckGo</a>.</p>
...
<p>Once the presentation is linked to the <a href="https://deckdeckgo.app">remote control</a>, the communication between these will happen through a real-time channel using <a href="https://webrtc.org/">WebRTC</a>.</p>
<h2 id="app-remote-control-give-it-a-try">Give it a try</h2>
<p>Better than a long description, the DeckDeckGo demo website implements a deck and receiver to let you interact with this application, just give it a try:</p>
<ol>
<li>Open the DeckDeckGo demo website 👉 <a href="https://demo.deckdeckgo.com">https://demo.deckdeckgo.com</a></li>
...
<p>Use the <a href="https://deckdeckgo.app">remote control</a> to remotely take control of your presentation. It makes it easy to interact with the slides while you are focusing on your talk/audience.</p>
...
<p>The <a href="https://deckdeckgo.app">remote control</a> lets you track your talk&#39;s time too. This application implements local notifications to inform you when your talk is about to finish or is finished.</p>
