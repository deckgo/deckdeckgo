...
<p>It&#39;s recommended to use <a href="https://unpkg.com/">unpkg</a> as a CDN for the <a href="https://deckdeckgo.com">DeckDeckGo</a> core. To do so, add the following include script in the main HTML file of your project:</p>
