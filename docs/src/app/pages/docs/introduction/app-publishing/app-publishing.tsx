...
<p><a href="https://deckdeckgo.com">DeckDeckGo</a> bundles your presentation as a Progressive Web App which then can be hosted on any Web Server or hosting solution.</p>
<blockquote>
...
<li><a href="#app-publishing-before-production">Pre-production</a></li>
...
<p>Before your final build and most importantly before publishing your deck online, don&#39;t forget to edit the information about your presentation in the following files:</p>
<ol>
<li><p>Edit the meta tags in the <code>&lt;head/&gt;</code> of your <code>src/index.html</code> file</p>
</li>
<li><p>Generate your icons and replace the respective files in the <code>assets</code> folder. I suggest using <a href="https://realfavicongenerator.net">RealFaviconGenerator</a>, which is a great tool for this purpose.</p>
</li>
...
<p>When you are ready for your talk or ready to publish your slides online, run the following command in a terminal to bundle your presentation for production:</p>
