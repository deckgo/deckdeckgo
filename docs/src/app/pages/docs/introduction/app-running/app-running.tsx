...
<p>Or you could showcase your deck locally, by running it in your favorite web browser using the integrated dev server provided by the <a href="https://deckdeckgo.com">DeckDeckGo</a> starter kit with the default access URL <a href="http://localhost:3000">http://localhost:3000</a>.</p>
...
<p><a href="https://github.com/johnpapa/lite-server">lite-server</a> is use as the integrated dev server.</p>
