...
<p>If you wish, you can edit your <a href="https://deckdeckgo.com">DeckDeckGo</a> presentation using Markdown. This chapter introduces you to the basic essentials of editing your slides with Markdown and how it differs from the HTML method.</p>
...
<p>When you edit your deck with Markdown, the <a href="https://github.com/deckgo/deckdeckgo/tree/master/webpack">DeckDeckGo Webpack Markdown Plugin</a> will convert, at bundle time, your code to HTML and will inject the results in the <code>index.html</code> file. Doing so, your <a href="https://deckdeckgo.com">DeckDeckGo</a> presentation will remain SEO friendly even without server side rendering.</p>
<h2 id="app-edit-markdown-edit">Edit</h2>
<p>To begin editing your deck, update the <code>index.md</code> file provided by the starter kit, instead of the <code>index.html</code>.</p>
<p>Furthermore, apart from the standard Markdown tags, you will be able to use extended tags in order to specify which types of slides you would like to use. For that purpose, use the separator <code>---</code> followed by a shortened version of the template&#39;s name, like for example <code>--- title</code> for <code>&lt;/deckgo-slide-title&gt;</code>.</p>
...
<p>For example to inject a <code>&lt;deckgo-slide-gif/&gt;</code> slide to the deck, use:</p>
<deckgo-highlight-code language="javascript">
      <code slot="code">--- gif src=&quot;https:&#47;&#47;media.giphy.com&#47;media&#47;xUA7baWfTjfHGLZc3e&#47;giphy.gif&quot; alt=&quot;My gif&quot; fullscreen=&quot;true&quot;{'\n'}# My title{'\n'}{'\n'}# Hey{'\n'}{'\n'}### It&#039;s cool gif</code>
    </deckgo-highlight-code><p>which then will be parsed into:</p>
<deckgo-highlight-code language="javascript">
...
<p>For that purpose, edit the <code>webpack.config.js</code> at the root of the presentation&#39;s project and provide a custom path, for example the following:</p>
<deckgo-highlight-code language="javascript">
