...
<p>After you have kick-started your presentation running <code>npm init deckdeckgo</code> in a terminal and provided the information as described in the <a href="https://docs.deckdeckgo.com/docs/introduction">Getting started</a> chapter, the <a href="https://deckdeckgo.com">DeckDeckGo</a> CLI will ask you if you are looking to use Google Fonts, and subsequently will try gathering more information of the required font.</p>
<p>Once all the information is accumulated, it will automatically download the fonts, add them to your presentation and even update the settings in the CSS stylesheets for you.</p>
...
<deckgo-highlight-code language="javascript">
    ...
    </deckgo-highlight-code><h2 id="app-edit-fonts-video">Video</h2>
