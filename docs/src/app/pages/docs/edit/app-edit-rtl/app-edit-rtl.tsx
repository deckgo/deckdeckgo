...
<p>Commonly, if you wish to use RTL for all of your pages in the presentation, you could set the attribute <code>dir</code> of the root <code>html</code> tag to <code>rtl</code>.</p>
