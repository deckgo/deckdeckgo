...
setupDeckGoConfig({
  ...
  cloud: {
    api: {
      cdn: 'https://unpkg.com/@deckdeckgo/ic@1.0.0-beta.8/dist/deckdeckgo-ic/index.esm.js'
    },
    signIn: {
      cdn: 'https://unpkg.com/@deckdeckgo/ic@1.0.0-beta.8/dist/deckdeckgo-ic/deckdeckgo-ic.esm.js',
