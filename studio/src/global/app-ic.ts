...
setupDeckGoConfig({
  ...
  cloud: {
    api: {
      cdn: 'https://unpkg.com/@deckdeckgo/ic@6.0.0/dist/deckdeckgo-ic/index.esm.js'
    },
    signIn: {
      cdn: 'https://unpkg.com/@deckdeckgo/ic@6.0.0/dist/deckdeckgo-ic/deckdeckgo-ic.esm.js',
