...
export class AppDeckDelete {
    ...
    render() {
        return [
            ...
            <ion-content class="ion-padding">
                <p>This action cannot be undone. This will permanently delete your presentation <strong>{this.deckName}</strong>.</p>
    ...
    private renderNotePublished() {
        if (this.published) {
            return <p class="ion-padding-top note">Please note that currently, your presentations are not automatically removed from internet. If you wish to unpublish them, drop us a message on one of our <a onClick={() => this.navigateContact()}>contact</a> channels.</p>
        } else {
            return undefined;
        }
    }
