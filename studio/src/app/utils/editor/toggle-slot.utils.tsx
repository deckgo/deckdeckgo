...
import {OrderedStyle, UnorderedStyle} from './list-style-type';
...
export class ToggleSlotUtils {
  ...
  static setListStyle(selectedElement: HTMLElement, listStyle: OrderedStyle | UnorderedStyle): Promise<HTMLElement> {
    return new Promise<HTMLElement>(async (resolve) => {
      if (!selectedElement || !selectedElement.parentElement) {
        resolve(null);
        return;
