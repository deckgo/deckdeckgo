        ...
        return [
            ...
            <ion-content class="ion-padding">
                ...
                <main class="ion-padding">
                    ...
                    <p class="ion-padding-top">Out of the box, without any special hardware or configuration, any presentations could be remote controlled with our “remote control” application.</p>
                    ...
                    <p class="ion-padding-bottom">Start the <a href="https://deckdeckgo.app" target="_blank">remote control</a> now 🚀</p>
